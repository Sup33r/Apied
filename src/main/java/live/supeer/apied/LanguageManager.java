...
public class LanguageManager {
    ...
    private final Apied plugin;
    private final String defaultLocale;
    private final Map<String, YamlConfiguration> locales;
    @Getter
    private final MiniMessage miniMessage;

    public LanguageManager(@NotNull Apied plugin, @NotNull String defaultLocale) {
        this.plugin = plugin;
    ...
    private YamlConfiguration getOrLoadLocale(@NotNull String locale) {
        ...
        if (resourceStream == null) {
            ...
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(resourceStream))) {
                ...
                plugin
                        .getLogger()
                        .log(Level.WARNING, "[Metropolis] Unable to load resource " + locale + ".yml", e);
                localeConfigDefaults = new YamlConfiguration();
            }
        }
        ...
        if (!file.exists()) {
            ...
            try {
                ...
                plugin
                        .getLogger()
                        .log(Level.WARNING, "[Metropolis] Unable to save resource " + locale + ".yml", e);
            }
        } else {
            ...
            if (!newKeys.isEmpty()) {
                plugin
                        .getLogger()
                        .info("[Metropolis] Added new language keys: " + String.join(", ", newKeys));
                try {
    ...
    public String getValue(
        ...
        if (replacements.length % 2 != 0) {
            plugin
                    .getLogger()
                    .log(Level.WARNING, "[Metropolis] Replacement data is uneven", new Exception());
        }
